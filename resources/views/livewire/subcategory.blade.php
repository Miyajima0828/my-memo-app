<div>
    ...
    @if ($userSubCount < 5) <!-- 各mainカテゴリーの右端に＋マーク表示し、mainカテゴリーに該当するsubカテゴリーをmainカテゴリのpの下にp,smallで表示 -->
        ...
        <h2>{{ $nowMainCategory }}<span>&nbsp;&nbsp;<a href="#" wire:click="updateMainCategory()">変</a>&nbsp;</span><span>&nbsp;<a href="#" wire:click="deleteMainCategory()">削</a>&nbsp;&nbsp;</span><span wire:click="input({{ $mainId }})">＋</span></h2>

        {{-- メインカテゴリーの変更 --}}
        @if ($updateMainCheck)
        <div>
            <p>"{{ $nowMainCategory }}"を<input type="text" wire:model.defer="newMainCategory" placeholder="メインカテゴリー名">に変更しますか？</p>
        ...
        <a href="#">
            ...
            <p><span wire:click="onClickUpdate('{{ $subItemArray['sub'] }}')">{{ $subItemArray['sub'] }}</span><span>&nbsp;&nbsp;<a href="#" wire:click="updateSubCategory({{ $nowSubId }})">変</a></span><span>&nbsp;&nbsp;<a href="#" wire:click="deleteSubCategory({{ $nowSubId }})">削</a></span></p>
        </a>

        {{-- サブカテゴリーの変更 --}}
        @if ($updateSubCheck && $nowSubId === $currentSub)
        <div>
            <p>"{{ $subItemArray['sub'] }}"を<input type="text" wire:model.defer="newSubCategory" placeholder="サブカテゴリー名">に変更しますか？</p>
        ...
        <h2>{{ $nowMainCategory }}<span>&nbsp;&nbsp;<a href="#" wire:click="updateMainCategory()">変</a>&nbsp;</span><span>&nbsp;<a href="#" wire:click="deleteMainCategory()">削</a>&nbsp;&nbsp;</span></h2>
