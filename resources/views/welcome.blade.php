    ...
    <style>
        ...
        *,
        ...
        .hover\:text-gray-700:hover {
            --tw-text-opacity: 1;
            items-center color: rgb(55 65 81 / var(--tw-text-opacity))
        }
    ...
    <div
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">ホーム</a>
                @else
                    <a href="{{ route('login') }}"
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="ml-4 font-semibold text-gray-600 hover:text-gray-900 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">サインイン</a>
                    @endif
                @endauth
            </div>
        @endif --}}
        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex-col">
                ...
                <h1 class="font-bold text-xl text-center text-gray-600">my-memo-app</h1>
